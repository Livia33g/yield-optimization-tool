...
#SBATCH -o /n/brenner_lab/Lab/rotation_livia/yield-optimization-tool/spheres/test2.out
#SBATCH -e /n/brenner_lab/Lab/rotation_livia/yield-optimization-tool/spheres/test2.err
