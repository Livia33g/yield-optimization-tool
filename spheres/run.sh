...
#SBATCH -o /n/brenner_lab/Lab/rotation_livia/yield-optimization-tool/spheres/test.out
#SBATCH -e /n/brenner_lab/Lab/rotation_livia/yield-optimization-tool/spheres/test.err
